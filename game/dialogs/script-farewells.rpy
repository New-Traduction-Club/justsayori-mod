...
init offset = 5
default -5 persistent.fae_first_leave_response = None

default -5 persistent.fae_player_force_quit_state = 1
...
label farewell_options:
    ...
    if isinstance(_return, basestring):
        show sayori idle zorder fae_sprites.FAE_SAYORI_ZORDER at t11
        $ ats(_return)
        jump cnc
