...
label fae_event_pointy_stick_stabber_girl:
    ...
    show asset knife as knife zorder fae_sprites.FAE_SAYORI_ZORDER at fae_center
...
label fae_event_sayori_desk_hide:
    ...
    window hide
    hide black
    show asset spe2 zorder fae_sprites.FAE_SAYORI_ZORDER at s11
    show emptydesk zorder 4 at t11
    pause 0.5
