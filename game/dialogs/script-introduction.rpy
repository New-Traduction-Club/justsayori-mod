...
label fae_intro_1:
    ...
    call updateconsole ("", "bg successfully updated!") from _call_updateconsole_3
...
label fae_intro_2:
    ...
    call updateconsole ("renpy.show_screen(\"main_ui\", \"False\")", "Showing screen...") from _call_updateconsole_4
...
label fae_intro_pre_loop:
    ...
    call s_topic_pronouns from _call_s_topic_pronouns
