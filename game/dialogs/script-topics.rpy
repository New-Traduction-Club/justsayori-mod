...
default -5 persistent._derp_known = True

default -5 persistent.ec = None


default -5 persistent.hl = None


default -5 persistent.hc = None


default -5 persistent.height = None


default -5 persistent.metric = True


init -6 python in chats:
    import store
    CHAT_DEFS = dict()
...
label s_answer_cookies:
    ...
    call updateconsole ("show cookies", "show cookies") from _call_updateconsole_5
...
label s_answer_read:
    ...
    call poem_list from _call_poem_list
...
label s_answer_opinion:
    ...
    menu:
        ...
        "Natsuki":
            call s_answer_game_opinion_n from _call_s_answer_game_opinion_n
        "Monika":
            call s_answer_game_opinion_m from _call_s_answer_game_opinion_m
        "Yuri":
            call s_answer_game_opinion_y from _call_s_answer_game_opinion_y
        "The Protagonist":
            call s_answer_game_opinion_mc from _call_s_answer_game_opinion_mc
    return
...
default -5 persistent._fae_sayori_love_count = 0
default -5 persistent._fae_sayori_love_count_time = datetime.datetime.now() - datetime.timedelta(days=1)
...
label sayo_love:
    ...
    if not persistent._fae_sayori_love_count == 0:
        ...
        call expression love_quip from _call_expression_1
...
label s_topics_backups:
    ...
    show sayori bbaaafae zorder fae_sprites.FAE_SAYORI_ZORDER at t11 with dissolve
    pause 2
    show sayori bbaaafag zorder fae_sprites.FAE_SAYORI_ZORDER at t11 with dissolve
    pause 2
    show sayori bbaaafa zorder fae_sprites.FAE_SAYORI_ZORDER at t11 with dissolve
    pause 2
