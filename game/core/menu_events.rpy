...
label talk_menu_wip:
    ...
    python:
        ...
        if renpy.exists(renpy.config.basedir + "game/submods/outfit.rpy"):
            talk_menu.append((_("Outfits"), "outfits_menu"))
    ...
    # at least, we dont have a outfits menu...
    elif madechoice == "outfit":
        call outifts_menu from _call_outfits_menu
