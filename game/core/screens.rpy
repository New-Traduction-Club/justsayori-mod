...
init python:
    ...
    layout.FAE_TT_NOTIF = (
        __("Enabling this will let Sayori use your system notifications, and check if JS is your active window")
    )
...
label fae_bad_name_input:
    ...
    if not renpy.seen_label("fae_bad_name_input.first_time_bad_name"):
        ...
        label fae_bad_name_input.first_time_bad_name:
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Quit") action Quit(confirm=(None))
...
default persistent.animate_room = True
