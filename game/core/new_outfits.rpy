...
init -1 python in fae_outfits:
    ...
    _m1_new_outfits__ALL_WEARABLES = {}
    _m1_new_outfits__ALL_OUTFITS = {}
    ...
    class FAEWearable():
        ...
        def load_all():
            ...
            global _m1_new_outfits__ALL_WEARABLES
            for wearable in _m1_new_outfits__ALL_WEARABLES.values():
                wearable._m1_new_outfits__load()
        ...
        def save_all():
            global _m1_new_outfits__ALL_WEARABLES
            for wearable in _m1_new_outfits__ALL_WEARABLES.values():
                wearable._m1_new_outfits__save()
        ...
        def filter_wearables(
            ...
            return [
                ...
                if _wearable._m1_new_outfits__filter_wearable(
                    unlocked,
                    is_fae_wearable,
                    reference_name,
                    not_reference_name,
        ...
        def _m1_new_outfits__load(self):
    ...
    class FAEOutfit():
        ...
        def load_all():
            ...
            global _m1_new_outfits__ALL_OUTFITS
            for outfit in _m1_new_outfits__ALL_OUTFITS.values():
                outfit._m1_new_outfits__load()
        ...
        def filter_outfits(
            ...
            return [
                ...
                if _outfit._m1_new_outfits__filter_outfit(
                    unlocked,
                    is_fae_outfit,
                    not_reference_name,
                    has_accessory,
        ...
        def _m1_new_outfits__delete_save(self):
            
            if store.persistent.fae_outfit_list[self.reference_name]:
                del store.persistent.fae_outfit_list[self.reference_name]
        
        
        def _m1_new_outfits__filter_outfit(
            self,
            unlocked=None,
            is_fae_outfit=None,
            not_reference_name=None,
    ...
    def _m1_new_outfits__register_outfit(outfit, player_created=False):
        ...
        if outfit.reference_name in _m1_new_outfits__ALL_OUTFITS:
            ...
            _m1_new_outfits__ALL_OUTFITS[outfit.reference_name] = outfit
    ...
    def _m1_new_outfits__register_wearable(wearable):
        ...
        if wearable.reference_name in _m1_new_outfits__ALL_WEARABLES:
            ...
            _m1_new_outfits__ALL_WEARABLES[wearable.reference_name] = wearable
    ...
    def _m1_new_outfits__delete_outfit(outfit):
        
        outfit._m1_new_outfits__delete_save()
        del _m1_new_outfits__ALL_OUTFITS[outfit.reference_name]

    def _check_wearable_sprites(wearable):
        
        WEARABLE_COMMON_PATH = os.path.join(_m1_new_outfits__WEARABLE_BASE_PATH, wearable.getFolderName())
    ...
    def _load_wearable_from_json(json):
        ...
        elif re.search(_m1_new_outfits__RESTRICTED_CHARACTERS_REGEX, json["reference_name"]):
    ...
    def _load_outfit_from_json(json):
        ...
        if not json["clothes"] in _m1_new_outfits__ALL_WEARABLES:
            ...
            outfit = FAEOutfit(
                ...
                unlocked=json["unlocked"],
                is_fae_outfit=False,
                clothes=_m1_new_outfits__ALL_WEARABLES[json["clothes"]],
                hairstyle=_m1_new_outfits__ALL_WEARABLES[json["hairstyle"]],
                accessory=_m1_new_outfits__ALL_WEARABLES[json["accessory"]] if "accessory" in json else None,
                eyewear=_m1_new_outfits__ALL_WEARABLES[json["eyewear"]] if "eyewear" in json else None,
                headgear=_m1_new_outfits__ALL_WEARABLES[json["headgear"]] if "headgear" in json else None,
                necklace=_m1_new_outfits__ALL_WEARABLES[json["necklace"]]  if "necklace" in json else None
            )
            ...
            _m1_new_outfits__register_outfit(outfit)
            return True
    ...
    def load_custom_outfits():
        ...
        if fae_utilities.makedirifnot(_m1_new_outfits__CUSTOM_OUTFITS_DIRECTORY):
            fae_utilities.log("Unable to load custom outfits as the directory does not exist, and had to be created.")
            return
        
        outfit_files = fae_utilities.getDirFile(_m1_new_outfits__CUSTOM_OUTFITS_DIRECTORY, ["json"])
        success_count = 0
    ...
    def load_custom_wearables():
        ...
        if fae_utilities.makedirifnot(_m1_new_outfits__CUSTOM_WEARABLES_DIRECTORY):
            fae_utilities.log("Unable to load custom wearables as the directory does not exist, and had to be created.")
            return
        
        wearable_files = fae_utilities.getDirFile(_m1_new_outfits__CUSTOM_WEARABLES_DIRECTORY, ["json"])
        success_count = 0
    ...
    def unload_custom_outfits():
        ...
        _m1_new_outfits__ALL_OUTFITS = FAEOutfit.filter_outfits(
    ...
    def unload_custom_wearables():
        ...
        _m1_new_outfits__ALL_WEARABLES = FAEWearable.filter_wearables(
    ...
    def outfit_exists(outfit_name):
        ...
        return outfit_name in _m1_new_outfits__ALL_OUTFITS

    def wearable_exists(wearable_name):
        
        return wearable_name in _m1_new_outfits__ALL_WEARABLES

    def get_outfit(outfit_name):
        
        if outfit_exists(outfit_name):
            return _m1_new_outfits__ALL_OUTFITS[outfit_name]
    ...
    def get_wearable(wearable_name):
        ...
        if wearable_exists(wearable_name):
            return _m1_new_outfits__ALL_WEARABLES[wearable_name]
    ...
    def get_all_outfits():
        ...
        return _m1_new_outfits__ALL_OUTFITS.values()


    def get_all_wearables():
        
        return _m1_new_outfits__ALL_WEARABLES.values()
    ...
    def save_custom_outfit(outfit):
        ...
        try:
            ...
            with open(os.path.join(_m1_new_outfits__CUSTOM_OUTFITS_DIRECTORY, "{0}.json".format(new_custom_outfit.reference_name)), "w") as file:
                file.write(new_custom_outfit.to_json_string())
            
            _m1_new_outfits__register_outfit(outfit=new_custom_outfit, player_created=True)
    ...
    def delete_custom_outfit(outfit):
        ...
        if fae_utilities.makedirifnot(_m1_new_outfits__CUSTOM_OUTFITS_DIRECTORY):
            ...
            path=os.path.join(_m1_new_outfits__CUSTOM_OUTFITS_DIRECTORY, "{0}.json".format(outfit.reference_name))
        ):
            ...
            _m1_new_outfits__delete_outfit(outfit)
