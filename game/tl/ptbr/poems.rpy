...
init 5 python:
    reg_poem_trans("long_wait", ptbr_long_wait)
    reg_poem_trans("poem_sunshine", ptbr_poem_sunshine)
    reg_poem_trans("poem_bottles", ptbr_poem_bottles)
    reg_poem_trans("poem_flower", ptbr_poem_flower)
    reg_poem_trans("poem_last", ptbr_poem_last)
    reg_poem_trans("poem_fruits", ptbr_poem_fruits)
    reg_poem_trans("poem_angel", ptbr_poem_angel)
    reg_poem_trans("poem_leaf", ptbr_poem_leaf)
    reg_poem_trans("poem_prose", ptbr_poem_prose)
    reg_poem_trans("poem_afterlight", ptbr_poem_afterlight)
    reg_poem_trans("poem_val", ptbr_poem_val)
