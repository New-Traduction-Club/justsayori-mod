...
screen bsod(bsodCode="DDLC_ESCAPE_PLAN_FAILED", bsodFile="libGLESv2.dll", rsod=False):
    ...
    if renpy.windows:
        ...
        vbox:
            ...
            text _("Debe reiniciar el ordenador. Mantenga pulsado el botón de\n")
        ...
        vbox:
            ...
            text _("Done.")
            text _("DDLC.so[[3352]: Importing _renpysteam: ImportError('No module named _renpysteam',)")
            text _("DDLC.so[[3352]: nvdrs: Loaded, about to disable thread optimizations.")
            text _("DDLC.so[[3352]: nvdrs: Disabled thread optimizations.")
